...
class ProfileCreationMobile extends StatefulWidget {
  const ProfileCreationMobile({super.key});

  @override
  State<ProfileCreationMobile> createState() => _ProfileCreationState();
}

class _ProfileCreationState extends State<ProfileCreationMobile> {
  String? fullname;
  String? address1;
