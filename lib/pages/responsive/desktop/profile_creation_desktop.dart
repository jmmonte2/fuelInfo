...
class ProfileCreationDesktop extends StatefulWidget {
  const ProfileCreationDesktop({super.key});

  @override
  State<ProfileCreationDesktop> createState() => _ProfileCreationState();
}

class _ProfileCreationState extends State<ProfileCreationDesktop> {
  String? fullname;
  String? address1;
